...
public class ForecastFragment extends Fragment  {
    ...
    public final static String LOG_TAG = "ForecastFragment";

    //Forecast List Variables
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        weekForecast.add("Mon - Cloudy - 72 / 63");
        weekForecast.add("Tues - Rainy - 64 / 51");
        weekForecast.add("Wed - Foggy - 70 / 46");
        weekForecast.add("Thur - Sunny - 76 / 68");
