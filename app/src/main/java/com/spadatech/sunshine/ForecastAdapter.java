...
/**
 * Created by Felipe on 7/19/2015.
 */
public class ForecastAdapter extends CursorAdapter {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        viewHolder.highTempView.setText(Utility.formatTemperature(mContext, highTemp, isMetric));

        double lowTemp = cursor.getDouble(ForecastFragment.COL_WEATHER_MIN_TEMP);
        viewHolder.lowTempView.setText(Utility.formatTemperature(mContext, lowTemp, isMetric));
    }
